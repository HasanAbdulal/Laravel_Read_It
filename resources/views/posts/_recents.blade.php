<div class="sidebar-box ftco-animate">
    ...
    <div class="block-21 mb-4 d-flex">
        ...
        <div class="text">
            ...
            <div class="meta">
                <div><a href="#"><span class="icon-calendar"></span> {{$posts->created_at->formt('M. d, Y')}}</a></div>
                <div><a href="#"><span class="icon-person"></span> {{$posts->author->firstname}} {{$posts->author->lastname}}</a></div>
